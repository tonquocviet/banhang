						...
						<div class="col-sm-4">
							<div class="single-item">
								...
								<div class="single-item-header">
									<a href="{{route('chitietsanpham',$sp_tt-> id)}}"><img src="source/image/product/{{$sp_tt-> image}}" alt="" height="150px"></a>
								</div>
								<div class="single-item-body">
									<p class="single-item-title">{{$sp_tt-> name}}</p>
									<p class="single-item-price">
										@if($sp_tt-> promotion_price==0)
										<span class="flash-sale">{{number_format($sp_tt-> unit_price).' đ'}}</span>
										@else
										<span class="flash-del">{{number_format($sp_tt-> unit_price).' đ'}}</span>
										<span class="flash-sale">{{number_format($sp_tt-> promotion_price).' đ'}}</span>
										@endif
									</p>
								</div>
