				...
				<div class="col-sm-12">
					<div class="beta-products-list">
						...
						<div class="beta-products-details">
							<p class="pull-center" align="center" >Tìm thấy sản {{count($new_product)}} phẩm</p>
					...
					<div class="beta-products-list">
						<h4 align="center"> Sản phẩm khuyến mãi</h4>
						<div class="beta-products-details">
							<p class="pull-center" align="center">Tìm thấy {{count($sanpham_khuyenmai)}} sản phẩm khuyến mãi</p>
							<div class="clearfix"></div>
						</div>
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="{{route('chitietsanpham',$spkm-> id)}}"><img src="source/image/product/{{$spkm-> image}}" alt="" height="205px"></a>
									</div>
									<div class="single-item-body">
